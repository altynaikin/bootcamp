...
class Modal extends Component {
  ...
  handleNameChange = event => {
    ...
    this.setState({ currentContact: { ...currentContact, name} })
  }
  ...
  handleLastNameChange = event => {
    ...
    this.setState({ currentContact: { ...currentContact, lastName} })
  }
  ...
  handlePhoneChange = event => {
    ...
    this.setState({ currentContact: { ...currentContact, phone} })
  }
        ...
        {this.state.isEdit ? (
          ...
          <div onClick={this.handleCloseModal} className="modal">
            <div className="modal-window">
              ...
              <button onClick={this.handleEdit} className="modal-window__btn edit">Edit</button>
            </div>
          </div>
          )}
      </>
